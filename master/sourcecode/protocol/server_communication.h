...
typedef struct
{
	...
	char cashbox1_balance[5];	//	硬币钱箱余额
	char cashbox2_balance[5];	//	纸币钱箱一报余额
	char cashbox3_balance[5];	//	纸币钱箱二报余额
	char cashbox1_deposit[5];	//	硬币钱箱存入总额
	char cashbox2_deposit[5];	//	纸币钱箱一存入总额
	char cashbox3_deposit[5];	//	纸币钱箱二存入总额
